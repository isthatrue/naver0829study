...
@Controller		// 자동으로 설정 파일에 bean 이 등록 
public class TestController {
	...
	// @GetMapping("/shop/list.do") // /shop/list.do만 호출 가능 꼭 찝어서 쓰면...
  @GetMapping("/shop/{path1}")		// @PathVariable("path1") :path1으로 넘어온 url 값을 읽는다
  ...
  public ModelAndView hello(HttpServletRequest request) {
		...
		mview.addObject("message", "맵핑주소로 사진을 나타내보자.");
