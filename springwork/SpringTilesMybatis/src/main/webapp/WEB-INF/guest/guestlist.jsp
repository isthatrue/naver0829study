...
<div>
	...
	<c:forEach var="dto" items="${glist }">
		<div class="guest_box">
			...
			<img src="https://4vnt4f9g1750.edge.naverncp.com/z0Dkh6sbnn/guest/${dto.guest_photo }?type=f&w=100&h=100&faceopt=true&ttype=jpg" class="img-thumbnail smallphoto" style="float: left; margin-right: 10px; cursor: pointer;"
...
<script type="text/javascript">
	$("img.smallphoto").click(function(){
		...
		// 모달 다이얼로그에 사진 넣기
		$("img.largephoto").attr("src", `https://kr.object.ncloudstorage.com/guest-h/guest/\${photoname}`);
	});
</script>
</body>
</html>