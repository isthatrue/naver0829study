...
public class BoardController {
    ...
    private String bucketName= "bitcamp.ncp-701";
    private String folderName= "bootmyshop";

    @PostMapping("/board/insert")
    public void insertBoard(@RequestParam(value = "upload", required = false) MultipartFile upload, 
    		@ModelAttribute BoardDto dto) {
    		// RequestBody 안 쓰는 이유는?
    		// 파일을 업로드 해야 할 때는 ModelAttribute를 사용한다고 한다.
    		// System.out.println("upload file = " + upload.getOriginalFilename()); 이렇게 하면 null 일경우에 없어서 에러 나온다 .
