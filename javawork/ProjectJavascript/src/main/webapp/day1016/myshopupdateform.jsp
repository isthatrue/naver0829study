...
<form action="./myshopupdate.jsp" method="post">
	...
	<table class="table table-bordered"
		style="width: 300px; margin: 30px 100px;">
		<caption align="top">
			<b>상품 등록</b>
		</caption>
		<tr>
			...
			<td><input type="text" name="sangpum" class="form-control"
				required="required" autofocus="autofocus" value=<%=dto.getSangpum() %>></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="color" name="color" class="form-control"
				value=<%=dto.getColor() %>></td>
		</tr>
		<tr>
			<td align="center" width="100">가 격</td>
			<td><input type="number" name="price" class="form-control"
				required="required" step=500 min=1000 max=100000 value=<%=dto.getPrice() %>></td>
		</tr>
		<tr>
