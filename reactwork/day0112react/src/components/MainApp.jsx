...
// import OneApp from "./OneApp.js"; // deafault로 export 한 경우
  ...
  return (
    <div>
      ...
      >
        ...
        <option value={4}>FourApp - 이름, 점수 입력 이벤트</option>
        <option value={5} selected>
          FiveApp - checkbox, select 이미지 이벤트
        </option>
      </select>
      <br />
      ...
      <br />
      {
        //조건 연산자를 이용하여 comp 값에 따라 해당 컴포넌트가 나오게 하기
        comp === 1 ? (
          <OneApp />
        ) : comp === 2 ? (
          <TwoApp />
