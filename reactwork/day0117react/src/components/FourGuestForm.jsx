...
function FourGuestForm({ onSave }) {
  const [photo, setPhoto] = useState("");
  const [nickname, setNickname] = useState("");
  // const [content, setContent] = useState("");

  // 많은 내용을 입력하는 textarea는 state 변수로 줄 경우 입력 시 마다 랜더링이 일어나므로
  // 문제가 발생하기도 한다.
  ...
  return (
    <div>
      ...
      <div className="input-group" style={{ width: "400px" }}>
        ...
        />
        <Button color="info" variant="contained" onClick={addButtonEvent}>
          추가
        </Button>
      </div>
      {/* <textarea
